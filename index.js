...
*/
const A187 = 'NTGXZFX BOT'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/ntgxzfx_?igshid=95tb5c02q655'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285865213494'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/JN2mCfonFIi0rG7KOsq5PD'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UCDgHRSJtjxv9s4NeZim0Azg'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *NTGXZFX BOT* , Follow Instagram Mimin Yah😻 https://instagram.com/ntgxzfx_?igshid=167egty7xo9oe ' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *NTGXZFZX BOT* , Follow Instagram Mimin Yah😻 :https://instagram.com/ntgxzfx_?igshid=167egty7xo9oe_' ,MessageType.text);
}
else if (text == '#menu'){
